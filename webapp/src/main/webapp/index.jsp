<form action="action_page.php">
  <div class="container">
    ...
    <label for="Name-2"><b>Enter Name</b></label>
    <input type="text" placeholder="Enter Full Name" name="Name" id="Name" required>
    <br>
    
    <label for="mobile-2"><b>Enter mobile</b></label>
    <input type="text" placeholder="Enter moible number" name="mobile" id="mobile" required>
    <br>

    <label for="email-2"><b>Enter Email</b></label>
    ...
    <label for="psw-repeat-2"><b>Repeat Password</b></label>
